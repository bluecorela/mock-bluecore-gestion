import { Controller, Post, Get, Body, Param, BadRequestException, Query, UseGuards } from '@nestjs/common';
...
export class PerformanceController {
    ...
    async save(@Body() data: CreatePerformanceEvaluationDto, @CurrentUser() user: AuthenticatedUser) {
    ...
    async enable(@Body() body: { teamId: string }, @CurrentUser() user: AuthenticatedUser) {
        if (!body.teamId) {
