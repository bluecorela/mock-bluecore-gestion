...
export class OtoService {
  ...
  async getConfig() {
    ...
    const sections = (rawSections as any[]).map((section) => ({
      ...
      questions: (section.questions ?? section.preguntas ?? []).map(
        (question: any) => ({
          key: question.key ?? question.clave,
          label: question.label,
          options: (question.options ?? question.opciones ?? []).map(
            (option: any) => ({
  ...
  async seedConfig() {
    const sections = [
      {
        ...
        questions: [
          {
            key: 'cargaTrabajo',
            label: '¿Cómo te sientes con tu carga de trabajo?',
          },
          {
            key: 'apoyoLider',
            label: '¿Hay algo que pueda hacer para apoyarte mejor?',
          },
          { key: 'retosRol', label: '¿Qué retos estás enfrentando en tu rol?' },
          {
            key: 'procesosEquipo',
            label:
              '¿Cómo podemos mejorar los procesos o las dinámicas del equipo?',
          },
          {
            key: 'feedbackLider',
            label: '¿Tienes algún feedback para mí como líder?',
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            opciones: [
              ...
              {
                valor: 2,
                descripcion: 'Aporta e interactúa cuando es necesario.',
              },
              {
                valor: 3,
                descripcion: 'Es muy participativo y fomenta la cooperación.',
              },
            ],
          },
          {
            ...
            opciones: [
              ...
              {
                valor: 2,
                descripcion: 'Expresa sus ideas, pero con fallas ocasionales.',
              },
              {
                valor: 3,
                descripcion: 'Se comunica claramente y escucha activamente.',
              },
            ],
          },
          {
            ...
            opciones: [
              ...
              {
                valor: 3,
                descripcion: 'Busca oportunidades y actúa sin esperar.',
              },
            ],
          },
          {
            ...
            opciones: [
              {
                valor: 1,
                descripcion: 'Tiene dificultades para encontrar soluciones.',
              },
              {
                valor: 2,
                descripcion: 'Resuelve problemas con ayuda o tiempo extra.',
              },
              {
                valor: 3,
                descripcion: 'Encuentra soluciones rápidas y efectivas.',
              },
            ],
          },
          {
            ...
            opciones: [
              ...
              {
                valor: 3,
                descripcion: 'Aprende rápido y aplica lo aprendido.',
              },
            ],
          },
        ],
      },
      {
        ...
        questions: [
          ...
          {
            key: 'objetivosProxPeriodo',
            label: 'Objetivos para el próximo periodo:',
          },
        ],
      },
    ];
    ...
    return {
      ok: true,
      message: 'Configuración de one-to-one importada a Supabase exitosamente',
    };
  }
