...
export class SoftSkillAnswerDto {
  ...
  @ApiProperty({
    ...
    example: 'Excelente proactividad',
    required: false,
  })
  @IsString()
  @IsOptional()
...
export class OtoSummaryDto {
  ...
  @ApiProperty({
    description: 'Promedio total final de los sprints',
    example: 88.5,
  })
  @IsNumber()
  @IsNotEmpty()
...
export class CreateOtoEvaluationDto {
  ...
  @ApiProperty({
    description: 'Preguntas de reflexión (texto libre por clave)',
    type: 'object',
  ...
  @ApiProperty({
    description: 'Habilidades blandas (calificacion + comentario por clave)',
    type: 'object',
    additionalProperties: {
      $ref: '#/components/schemas/HabilidadBlandaRespuestaDto',
    },
  })
  @IsObject()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Síntesis final (texto libre por clave)',
    type: 'object',
    additionalProperties: { type: 'string' },
  })
  @IsObject()
  ...
  @ApiProperty({
    description: 'Resumen de métricas de los 4 sprints',
    type: OtoSummaryDto,
  })
  @IsObject()
  @IsNotEmpty()
