...
export class RotatePersonnelDto {
  @ApiProperty({
    description: 'ID del personal a rotar',
    example: 'person-123',
  })
  @IsString()
  @IsNotEmpty()
...
export class VacationDto {
  @ApiProperty({
    description: 'ID del personal que sale de vacaciones',
    example: 'person-123',
  })
  @IsString()
  @IsNotEmpty()
...
export class ReintegrateDto {
  @ApiProperty({
    description: 'ID del personal a reintegrar',
    example: 'person-123',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'ID del equipo destino (opcional)',
    example: 'team-456',
    required: false,
  })
  @IsString()
  ...
  @ApiProperty({
    description: 'ID del equipo origen (opcional)',
    example: 'pool-de-vacaciones',
    required: false,
  })
  @IsString()
  @IsOptional()
