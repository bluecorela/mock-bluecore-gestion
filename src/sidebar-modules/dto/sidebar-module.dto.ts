...
export const SIDEBAR_ROLE_CODES = [
  'ADMIN', 'ARCHITECT', 'SCRUM_MASTER', 'SOFTWARE_ENGINEER',
  'QA_ENGINEER', 'WELLBEING_CREATOR', 'INTERN',
] as const;
...
export class CreateSidebarModuleDto {
  ...
  @ApiProperty({ enum: SIDEBAR_ROLE_CODES, isArray: true, example: ['ADMIN', 'ARCHITECT'] })
  @IsArray()
  @ArrayNotEmpty()
...
export class UpdateSidebarModuleDto extends PartialType(CreateSidebarModuleDto) {}
